        ...
        <div class="media-container-row">
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                ...
                <div class="plan-body">
                    ...
                    <div class="mbr-section-btn text-center py-4 pb-5"><a href="index.jsp#features18-1o" class="btn btn-warning-outline display-4">ADERIR</a></div>
                </div>
            </div>
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center favorite col-lg-3">
                ...
                <div class="plan-body">
                    ...
                    <div class="mbr-section-btn text-center py-4 pb-5"><a href="index.jsp#features18-1o" class="btn btn-danger-outline display-4">ADERIR</a></div>
                </div>
            </div>
            ...
            <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                ...
                <div class="plan-body">
                    ...
                    <div class="mbr-section-btn text-center py-4 pb-5"><a href="index.jsp#features18-1o" class="btn btn-info-outline display-4">ADERIR</a></div>
                </div>
            </div>
