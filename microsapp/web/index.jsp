<%-- 
    Document   : index
    Created on : Mar 22, 2019, 6:41:11 AM
...
<html>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
                ...
                <div class="menu-logo">
                    <div class="navbar-brand">
                        ...
                        <span class="navbar-caption-wrap"><a class="navbar-caption text-secondary display-4" href="index.jsp">MICRÓCREDITOS, E.I</a></span>
                    </div>
                </div>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item">
                            <a class="nav-link link text-primary display-7" href="index.jsp">HOME</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link link text-primary display-7" href="index.jsp#features6-18">QUEM SOMOS</a>
                        </li><li class="nav-item dropdown"><a class="nav-link link text-primary dropdown-toggle display-7" href="index.jsp#pricing-tables2-v" aria-expanded="false" data-toggle="dropdown-submenu">CRÉDITOS</a><div class="dropdown-menu"><a class="text-primary dropdown-item display-7" href="index.jsp#pricing-tables2-v" aria-expanded="false">LINHAS DE CREDITO</a><a class="text-primary dropdown-item display-7" href="index.jsp#features18-1o" aria-expanded="false">REQUISITOS</a><a class="text-primary dropdown-item display-7" href="index.jsp#gallery1-1a" aria-expanded="false">APLICACAÇÕES</a></div></li><li class="nav-item"><a class="nav-link link text-primary display-7" href="index.jsp#footer1-b">CONTACTOS</a></li></ul>
                    <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-secondary display-7" href="tamplates/login.jsp"><span class="mbri-login mbr-iconfont mbr-iconfont-btn"></span>ENTRAR</a></div>
                </div>
            </nav>
        </section>

        <section class="engine"><a href="https://mobirise.info/t">free amp templates</a></section><section class="carousel slide cid-rbVtlNA7dJ" data-interval="false" id="slider1-1e">



            <div class="full-screen"><div class="mbr-slider slide carousel" data-pause="true" 
                                          data-keyboard="false" data-ride="carousel" data-interval="5000">
                    <ol class="carousel-indicators"><li data-app-prevent-settings="" data-target="#slider1-1e" data-slide-to="0">
                        
                        </li><li data-app-prevent-settings="" data-target="#slider1-1e" data-slide-to="1"></li>
                        <li data-app-prevent-settings="" data-target="#slider1-1e" data-slide-to="2"></li>
                        <li data-app-prevent-settings="" data-target="#slider1-1e" data-slide-to="3"></li>
                        <li data-app-prevent-settings="" data-target="#slider1-1e" class=" active" data-slide-to="4"></li></ol>
                    <div class="carousel-inner" role="listbox"><div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/mbr-1920x1278.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay" style="background-color: rgb(0, 0, 0);"></div><img src="assets/images/mbr-1920x1278.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><h2 class="mbr-fonts-style display-1">OPERADOR DE MICROCRÉDITOS</h2><p class="lead mbr-text mbr-fonts-style display-5">O sistema de microcrédito é uma linha que concede empréstimos de baixo valor e a taxas menores de juros a pequenos empreendedores, comerciantes e funcionários do estado.</p></div></div></div></div></div><div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/bguser-2000x1333.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="assets/images/bguser-2000x1333.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><h2 class="mbr-fonts-style display-1">Linhas de Créditos</h2><p class="lead mbr-text mbr-fonts-style display-5">Créditos para funcionários, comerciantes, empreendedores e o público em geral.</p></div></div></div></div></div><div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/mbr-2-1920x1280.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="assets/images/mbr-2-1920x1280.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><h2 class="mbr-fonts-style display-2">COMO ADIQUIRIR DINHEIRO</h2><p class="lead mbr-text mbr-fonts-style display-5">Os créditos são destinados à funcionários públicos e ou empresas com comparticipação do estado, pequenas e médias empresas.</p><div class="mbr-section-btn" buttons="0"> <a class="btn  display-4 btn-white-outline" href="index.jsp#features18-1o"><span class="mbri-touch-swipe mbr-iconfont mbr-iconfont-btn"></span>MAIS INFORMAÇÕES</a> </div></div></div></div></div></div><div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/mbr-1920x1271-800x530.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="assets/images/mbr-1920x1271-800x530.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><h2 class="mbr-fonts-style display-2">NOSSAS SOLUÇÕES E OPORTUNIDADES</h2><p class="lead mbr-text mbr-fonts-style display-5">Oferecemos emprestimos monetários à seu favor para a realização dos seus sonhos.</p></div></div></div></div></div><div class="carousel-item slider-fullscreen-image active" data-bg-video-slide="false" style="background-image: url(assets/images/01.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="assets/images/01.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><h2 class="mbr-fonts-style display-2">Estrangelal Jamal Microcréditos, E.I</h2><p class="lead mbr-text mbr-fonts-style display-5">Somos uma empresa engajada no emprestimo de dinheiro à pessoas singulares e empresas.</p><div class="mbr-section-btn" buttons="0"> <a class="btn  btn-white-outline display-4" href="index.jsp#form1-l"><span class="mbri-credit-card mbr-iconfont mbr-iconfont-btn"></span>PEDIR DINHEIRO</a></div></div></div></div></div></div></div><a data-app-prevent-settings="" class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#slider1-1e"><span aria-hidden="true" class="mbri-left mbr-iconfont"></span><span class="sr-only">Previous</span></a><a data-app-prevent-settings="" class="carousel-control carousel-control-next" role="button" data-slide="next" href="#slider1-1e"><span aria-hidden="true" class="mbri-right mbr-iconfont"></span><span class="sr-only">Next</span></a></div></div>
            ...
            <div class="container">
                <div class="row justify-content-center content-row">
                    <div class="media-container-column title col-12 col-lg-7 col-md-6">
                        ...
                        <h2 class="align-left mbr-bold mbr-fonts-style display-5">ENTRANGELAL JAMAL MICROCRÉDITOS, E.I</h2>
                    </div>
                    <div class="media-container-column col-12 col-lg-3 col-md-4">
                        <div class="mbr-section-btn align-right py-4"><a class="btn btn-primary display-4" href="index.jsp#form1-l"><span class="mobi-mbri mobi-mbri-phone mbr-iconfont mbr-iconfont-btn"></span>CONCTATE</a></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="mbr-section info1 cid-rbTOfkBtKD" id="info1-15">
            ...
            <div class="container">
                <div class="row justify-content-center content-row">
                    ...
                    <div class="media-container-column col-12 col-lg-3 col-md-4">
                        <div class="mbr-section-btn align-right py-4"><a class="btn btn-primary display-4" href="index.jsp#form1-l"><span class="mbri-key mbr-iconfont mbr-iconfont-btn"></span>CRIAR CONTA</a></div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="media-container-row">
                        ...
                        <div class="plan-header text-center pt-5">
                            ...
                            <div class="plan-price">
                                ...
                                <span class="price-figure mbr-fonts-style display-5">
                                    16.6%</span>
                                <small class="price-term mbr-fonts-style display-7">(90 Dias máximo)&nbsp;</small>
                            </div>
                        </div>
                        <div class="plan-body">
                            ...
                            <div class="mbr-section-btn text-center py-4 pb-5">
                                <a href="#" data-toggle="modal" data-target="#credits_modal" role="dialog" class="btn btn-primary-outline display-4">ADERIR</a></div>

                            <% } else {%>

                            <div class="mbr-section-btn text-center py-4 pb-5">
                                <a href="tamplates/login.jsp" class="btn btn-primary-outline display-4">ADERIR</a></div>
                                <% }%>
                        </div>
                    </div>
                    ...
                    <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                        <div class="plan-header text-center pt-5">
                            ...
                            <div class="plan-price">
                                <span class="price-value mbr-fonts-style display-5">&nbsp;</span>
                                <span class="price-figure mbr-fonts-style display-5">12.5%&nbsp;</span>
                                <small class="price-term mbr-fonts-style display-7">(120 Dias máximo)</small>
                            </div>
                        </div>
                        <div class="plan-body">
                            <div class="plan-list align-center">
                             ...
                             <%if (request.getAttribute("username") != null) { %>
                            <div class="mbr-section-btn text-center py-4 pb-5">
                                <a href="#" data-toggle="modal" data-target="#credits_modal" role="dialog" class="btn btn-warning-outline display-4">ADERIR</a></div>
                                 
                            <% } else {%>
                            
                             <div class="mbr-section-btn text-center py-4 pb-5">
                                 <a href="tamplates/login.jsp" class="btn btn-warning-outline display-4">ADERIR</a></div>
                    ...
                    <div class="plan col-12 mx-2 my-2 justify-content-center favorite col-lg-3">
                        <div class="plan-header text-center pt-5">
                            ...
                            <div class="plan-price">
                                <span class="price-value mbr-fonts-style display-5">&nbsp;</span>
                                <span class="price-figure mbr-fonts-style display-5">16.6%</span>
                                <small class="price-term mbr-fonts-style display-7">(90 Dias Máximo)</small>
                            </div>
                        </div>
                        <div class="plan-body">
                            ...
                            <%if (request.getAttribute("username") != null) { %>
                            <div class="mbr-section-btn text-center py-4 pb-5">
                                <a href="#" data-toggle="modal" data-target="#credits_modal" role="dialog" class="btn btn-danger-outline display-4">ADERIR</a></div>
                                  
                            <% } else {%>
                            
                            <div class="mbr-section-btn text-center py-4 pb-5">
                                <a href="tamplates/login.jsp" class="btn btn-danger-outline display-4">ADERIR</a></div>
                                  <% } %>
                    ...
                    <div class="plan col-12 mx-2 my-2 justify-content-center col-lg-3">
                        ...
                        <div class="plan-body">
                            <div class="plan-list align-center">
                             ...
                             <%if (request.getAttribute("username") != null) { %>
                            <div class="mbr-section-btn text-center py-4 pb-5">
                                <a href="#" data-toggle="modal" data-target="#credits_modal" role="dialog"  class="btn btn-info-outline display-4">ADERIR</a></div>
                                  
                            <% } else {%>
                             <div class="mbr-section-btn text-center py-4 pb-5">
                                 <a href="tamplates/login.jsp" class="btn btn-info-outline display-4">ADERIR</a></div>
        ...
        <section class="features18 popup-btn-cards cid-rc5gTeI85K" id="features18-1o">
            ...
            <div class="container">
                ...
                <h3 class="mbr-section-subtitle display-5 align-center mbr-fonts-style mbr-light">
                    LISTA DE REQUISITOS PARA TER ACESSO AO CRÉDITO</h3>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="media-container-column col-lg-8" data-form-type="formoid">
                        ...
                        <form class="mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="p5v5iakbPfLYzOYoDrjJGWIaY3y2tkLwY+0Oh0dVU/dcxCCeD+0/toE+s1VXsZKCTi4Wi9LRDTJagHrwr4KPKydoi7x9gwd7cUOXR2d8bNFBpjxPCJ/KeFGmcQY7kEuh">
                            ...
                            <span class="input-group-btn"><button href="" type="submit" class="btn btn-form btn-danger display-4"><span class="mbri-share mbr-iconfont mbr-iconfont-btn" style="color: rgb(239, 239, 239);"></span>ENVIAR MENSAGEM</button></span>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <section class="mbr-section article content1 cid-riy4zx23F0" id="content2-1q">
            ...
            <div class="container">
                <div class="media-container-row">
                    <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-4">
                        <blockquote><p> <strong>Estrangelal Jamal Microcréditos!</strong>&nbsp;Venha Para onde está a <a href="index.jsp#form1-l" class="text-secondary">Solução Dinheiro na Hora !!</a>&nbsp;&nbsp;<span style="font-size: 1.09rem;">O crédito é rapido e os prazos são de pagamentos são curtos; 
                                </span><span style="font-size: 1.09rem;">&nbsp;</span><span style="font-size: 1.09rem;">As Solicitações de garantias reais (patrimônio), documentos e testemunhas são necessárias dependendo do valor e do tipo de Crédito; &nbsp;</span></p></blockquote>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="media-container-row content text-white">
                    <div class="col-12 col-md-3">
                        <div class="media-wrap">
                            <a href="index.jsp">
                                <img src="assets/images/logotipo05-256x310.png" alt="Mobirise" title="">
                            </a>
                        </div>
                    </div>
                    <div class="col-12 col-md-3 mbr-fonts-style display-7">
                        <h5 class="pb-3">Endereço</h5>
                        <p class="mbr-text">Cidade de Pemba, Via ANE<br>Bairro Eduardo Mondlane<br>Quarterão nº 19, Rua 026</p>
                    </div>
                    <div class="col-12 col-md-3 mbr-fonts-style display-7">
                        <h5 class="pb-3">
                            Contactos</h5>
                    ...
                    <div class="col-12 col-md-3 mbr-fonts-style display-7">
                        <h5 class="pb-3">Público Alvo</h5>
                        <p class="mbr-text">Funcionarios do Estado<br>Negociantes e Empreendedores<br>Pessoas com Bens a Penhorar</p>
                    </div>
                </div>
